<template>
  <div class="bg-gray-50">
    <div class="relative bg-cover bg-center" style="background-image:  url('https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=3540&q=80')">
      ...
      <div class="relative mt-12 flex justify-center sm:mt-16">
        <div class="flex rounded-lg bg-white/60 backdrop-blur p-0.5">
          <button
            type="button"
            class="
              relative
              ...
              >
                <div class="mt-3 flex items-center">
                  ...
                  <div class="ml-4">
                    ...
                    >
                      Billed yearly (${{ plan.priceYearly.toLocaleString() }})
                    </p>
                  </div>
                </div>
                <a
                  ...
                  :class="[
                    plan.featured
                      ? 'bg-cyan-500 text-white hover:bg-indigo-700'
                      : 'bg-white text-indigo-600 hover:bg-indigo-50',
                    'mt-6 w-full inline-block py-2 px-8 border border-transparent rounded-md shadow-sm text-center text-sm font-medium sm:mt-0 sm:w-auto lg:mt-6 lg:w-full',
                  ]"
                  >{{ plan.featured ? 'Your plan' : `Buy ${plan.title}` }}</a
                >
              </div>
            </div>
...
const features = [
  {
    ...
    tiers: [
      ...
      { title: "popular", featured: true, value: "Unlimited" },
  ...
  },
  {
    ...
    tiers: [
      ...
      { title: "popular", featured: true, value: "2" },
      { title: "intermediate", value: "Unlimited" },
    ],
  },
  {
    title: "Workflows",
    tiers: [
      { title: "starter", value: "3 included" },
      { title: "popular", featured: true, value: "5 included" },
      { title: "intermediate", value: "10 included" },
    ],
  },
];
const perks = [
  ...
  },
  {
    ...
    tiers: [
      { title: "starter", value: false },
      { title: "popular", featured: true, value: "Add-on" },
      { title: "intermediate", value: true },
    ],
  },
  {
