        ...
        <div class="relative lg:-my-8">
          ...
          <div class="mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:h-full lg:p-0">
            <div class="aspect-w-10 aspect-h-6 overflow-hidden rounded-xl shadow-xl sm:aspect-w-16 sm:aspect-h-7 lg:aspect-none lg:h-full">
              <img class="object-cover lg:h-full lg:w-full" src="https://images.ctfassets.net/7rbn0raz0t75/5yPxRQjUcNGAHayXp4bF9F/a8874ae9750673ae5e9ea5f891fe85b5/david-dorman.jpeg?w=3840&q=100" alt="" />
            </div>
          </div>
        </div>
          ...
          <div class="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 lg:max-w-none lg:px-0 lg:py-20">
            <blockquote>
              <div>
                ...
                <p class="mt-6 text-2xl font-medium text-white">With the Tray Platform, we can easily update and integrate workflows and transform data without needing any engineering resources.</p>
              </div>
              <footer class="mt-6">
                <p class="text-base font-medium text-white">David Dorman</p>
                <p class="text-base font-medium text-indigo-100">Director of Growth at Digital Ocean</p>
              </footer>
            </blockquote>
          </div>
        </div>
